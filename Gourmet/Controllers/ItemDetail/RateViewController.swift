...
class RateViewController: UIViewController, UITextViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        commetTextView.anchor(top: ratingStarView.bottomAnchor, left: view.leftAnchor, bottom: rateButton.topAnchor, right: view.rightAnchor, paddingTop: 15*designHeightRatio, paddingLeft: 15, paddingBottom: 15*designHeightRatio, paddingRight: 15, width: 0, height: 0)
    }
